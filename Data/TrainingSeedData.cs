...
namespace ETMP.Data
{
	public class TrainingSeedData
	{
		public static async Task InitTrainings(ApplicationDbContext context)
		{
            ...
            if (await context.Trainings.FindAsync("Training 1") == null)
			{
			...
			if (await context.Trainings.FindAsync("Training 2") == null)
			{
			...
			if (await context.Trainings.FindAsync("Training 3") == null)
			{
			...
			if (await context.Trainings.FindAsync("Training 4") == null)
			{
